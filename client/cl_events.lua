...
RegisterNetEvent('ls-dispatch:client:drugsale', function()
    DrugSale()
end)
...
RegisterNetEvent("ls-dispatch:client:officerdown", function ()
    OfficerDown()
end)
...
RegisterNetEvent("ls-dispatch:client:emsdown", function ()
    EmsDown()
end)
