...
```lua
- exports['ls-dispatch']:VehicleShooting(vehicle)

- exports['ls-dispatch']:Shooting()

- exports['ls-dispatch']:OfficerDown()

- exports['ls-dispatch']:SpeedingVehicle(vehicle)

- exports['ls-dispatch']:Fight()

- exports['ls-dispatch']:InjuriedPerson()

- exports['ls-dispatch']:DeceasedPerson()

- exports['ls-dispatch']:StoreRobbery(camId)

- exports['ls-dispatch']:FleecaBankRobbery(camId)

- exports['ls-dispatch']:PaletoBankRobbery(camId)

- exports['ls-dispatch']:PacificBankRobbery(camId)

- exports['ls-dispatch']:PrisonBreak()

- exports['ls-dispatch']:VangelicoRobbery(camId)

- exports['ls-dispatch']:HouseRobbery()

- exports['ls-dispatch']:DrugSale()

- exports['ls-dispatch']:ArtGalleryRobbery()

- exports['ls-dispatch']:HumaneRobery()

- exports['ls-dispatch']:TrainRobbery()

- exports['ls-dispatch']:VanRobbery()

- exports['ls-dispatch']:UndergroundRobbery()

- exports['ls-dispatch']:DrugBoatRobbery()

- exports['ls-dispatch']:UnionRobbery()

- exports['ls-dispatch']:YachtHeist()

- exports['ls-dispatch']:CarBoosting(vehicle)

- exports['ls-dispatch']:CarJacking(vehicle)

- exports['ls-dispatch']:VehicleTheft(vehicle)

- exports['ls-dispatch']:SuspiciousActivity()

- exports['ls-dispatch']:SignRobbery()
```
...
```lua 
exports['ls-dispatch']:TestVehicleAlert(vehicle)
```

and its function in ls-dispatch would look like this
